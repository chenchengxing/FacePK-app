 ...
 */
app.controller('AppCtrl', function($scope, $cordovaPush, $cordovaDialogs, $cordovaMedia, $cordovaToast, ionPlatform, $http, $cordovaCamera, $jrCrop) {
  $scope.notifications = [];
  $scope.notiCount = 0;
  $scope.noti = 'init';
  $scope.logs = [];
  ...
  $scope.register = function() {
    ...
    $cordovaPush.register(config).then(function(result) {
      ...
      // $cordovaDialogs.alert('Registered for push notifications');
